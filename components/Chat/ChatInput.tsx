...
export const ChatInput = ({
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full border-transparent bg-gradient-to-b from-transparent via-white to-white pt-6 dark:border-yellow-zerobi dark:via-black-zerobi dark:to-black-zerobi md:pt-2">
      <div className="stretch mx-2 mt-4 flex flex-row gap-3 last:mb-2 md:mx-4 md:mt-[52px] md:last:mb-6 lg:mx-auto lg:max-w-3xl">
        ...
        <div className="relative mx-2 flex w-full flex-grow flex-col rounded-md border border-black/10 bg-white shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:border-yellow-zerobi dark:bg-black-zerobi dark:text-yellow-zerobi dark:shadow-[0_0_15px_rgba(0,0,0,0.10)] sm:mx-4">
          ...
          <textarea
            ref={textareaRef}
            className="m-0 w-full resize-none border-0 bg-transparent p-0 py-2 pr-8 pl-10 text-blue-zerobi font-mono dark:bg-black-zerobi dark:text-yellow-zerobi md:py-3 md:pl-10"
            style={{
              resize: 'none',
          ...
          {showScrollDownButton && (
            <div className="absolute bottom-12 right-0 lg:bottom-0 lg:-right-10">
              <button
                className="flex h-7 w-7 items-center justify-center rounded-full bg-neutral-300 text-blue-zerobi-800 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-black-zerobi dark:text-yellow-zerobi"

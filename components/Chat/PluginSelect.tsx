...
export const PluginSelect: FC<Props> = ({
  ...
  return (
    <div className="flex flex-col">
      <div className="mb-1 w-full rounded border border-blue-zerobi bg-transparent pr-2 text-blue-zerobi dark:border-yellow-zerobi dark:text-yellow-zerobi">
        <select
          ref={selectRef}
        ...
        >
          <option
            key="chatgpt"
            value="chatgpt"
            className="dark:bg-black-zerobi dark:text-yellow-zerobi"
          >
            ChatGPT
          </option>
